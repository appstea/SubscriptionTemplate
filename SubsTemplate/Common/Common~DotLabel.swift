...
final class DotLabel: Base.View {

  var text: NSAttributedString? { didSet { setNeedsDisplay() } }

  var dotSize = 12.ui { didSet { setNeedsDisplay() } }
  var dotPadding = 14.ui { didSet { setNeedsDisplay() } }
  var dotColor: UIColor? { didSet { setNeedsDisplay() } }
